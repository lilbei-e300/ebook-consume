    ...
    <div className="flex flex-col flex-1 w-full">
      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-4xl mx-auto">
        <div>
          ...
          <div>
            <div className="grid ">
              <button className="inline-flex items-center justify-center gap-3 py-4 text-base font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-8 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
